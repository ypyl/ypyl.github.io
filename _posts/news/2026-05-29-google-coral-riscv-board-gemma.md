...
Source code for all demo projects is available on [GitHub](https://github.com/google-coral). Shipments are expected to begin this summer; pricing has not yet been disclosed.

[Google Gemma on X](https://x.com/googlegemma/status/2059740184930074758) · [Coral Board product page](https://developers.google.com/coral/products/SL2610-dev-board)
