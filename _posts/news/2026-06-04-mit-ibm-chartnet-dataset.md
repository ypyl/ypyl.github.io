...
According to the researchers, fine-tuning on ChartNet enabled compact models to outperform larger proprietary systems on specialized visual information extraction benchmarks. The dataset is available on [Hugging Face](https://huggingface.co/datasets/ibm-granite/ChartNet).

[MIT News: Teaching AI models to interpret charts](https://news.mit.edu/2026/mit-researchers-teach-ai-models-to-interpret-charts-0603) · [Paper on arXiv](https://arxiv.org/pdf/2603.27064)
