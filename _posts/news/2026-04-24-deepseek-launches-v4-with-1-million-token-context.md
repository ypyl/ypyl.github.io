...
For technical details and model access, see the [DeepSeek V4 Tech Report](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro/blob/main/DeepSeek_V4.pdf) and [Open Weights on Hugging Face](https://huggingface.co/collections/deepseek-ai/deepseek-v4).
