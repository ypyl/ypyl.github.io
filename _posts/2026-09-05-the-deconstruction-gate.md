...
{::nomarkdown}
<figure>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 480" role="img" style="width:100%;height:auto" font-family="-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif">
  <title>Deconstruct before you delegate</title>
  <desc>In the deconstruction phase you strip the problem to its truths and encode them in a brief. The brief crosses to AI, which generates candidate directions and tests them against the truths, iterating until the brief holds. You make the final call.</desc>
  <defs>
    <pattern id="dots" width="22" height="22" patternUnits="userSpaceOnUse">
      <circle cx="1" cy="1" r="0.9" fill="#E3E2DC"/>
    </pattern>
  </defs>
  <rect width="1000" height="480" fill="#f5f4ed"/>
  <rect width="1000" height="480" fill="url(#dots)" opacity="0.55"/>

  <text x="64" y="40" fill="#1B365D" font-size="14" font-weight="600" font-family="'JetBrains Mono','SF Mono','Fira Code',Consolas,Monaco,monospace" letter-spacing="3">FIGURE  1</text>
  <text x="200" y="40" fill="#504e49" font-size="14" font-family="'JetBrains Mono','SF Mono','Fira Code',Consolas,Monaco,monospace" letter-spacing="3">DECONSTRUCT BEFORE YOU DELEGATE</text>
  <line x1="64" y1="52" x2="920" y2="52" stroke="#1B365D" stroke-width="0.8"/>

  <text x="64" y="104" fill="#6b6a64" font-size="14" font-family="'JetBrains Mono','SF Mono','Fira Code',Consolas,Monaco,monospace" letter-spacing="3">YOU · DECONSTRUCT</text>
  <text x="672" y="104" fill="#6b6a64" font-size="14" font-family="'JetBrains Mono','SF Mono','Fira Code',Consolas,Monaco,monospace" letter-spacing="3">AI · GENERATE &amp; TEST</text>

  <rect x="64" y="120" width="160" height="64" rx="6" fill="#faf9f5" stroke="#141413" stroke-width="1.5"/>
  <text x="144" y="150" text-anchor="middle" font-size="18" font-weight="600" fill="#141413">PROBLEM</text>
  <text x="144" y="170" text-anchor="middle" font-size="14" fill="#6b6a64">the ask as given</text>

  <rect x="64" y="232" width="160" height="64" rx="6" fill="#EEF2F7" stroke="#1B365D" stroke-width="1.5"/>
  <text x="144" y="262" text-anchor="middle" font-size="18" font-weight="600" fill="#141413">TRUTHS</text>
  <text x="144" y="282" text-anchor="middle" font-size="14" fill="#6b6a64">what must remain true</text>

  <rect x="64" y="344" width="160" height="64" rx="6" fill="#faf9f5" stroke="#141413" stroke-width="1.5"/>
  <text x="144" y="374" text-anchor="middle" font-size="18" font-weight="600" fill="#141413">BRIEF</text>
  <text x="144" y="394" text-anchor="middle" font-size="14" fill="#6b6a64">constraints + tests</text>

  <rect x="672" y="120" width="160" height="64" rx="6" fill="#faf9f5" stroke="#141413" stroke-width="1.5"/>
  <text x="752" y="150" text-anchor="middle" font-size="18" font-weight="600" fill="#141413">CANDIDATES</text>
  <text x="752" y="170" text-anchor="middle" font-size="14" fill="#6b6a64">generate N directions</text>

  <rect x="672" y="232" width="160" height="64" rx="6" fill="#faf9f5" stroke="#141413" stroke-width="1.5"/>
  <text x="752" y="262" text-anchor="middle" font-size="18" font-weight="600" fill="#141413">TEST</text>
  <text x="752" y="282" text-anchor="middle" font-size="14" fill="#6b6a64">run against truths</text>

  <rect x="672" y="344" width="160" height="64" rx="6" fill="#faf9f5" stroke="#141413" stroke-width="1.5"/>
  <text x="752" y="374" text-anchor="middle" font-size="18" font-weight="600" fill="#141413">DECISION</text>
  <text x="752" y="394" text-anchor="middle" font-size="14" fill="#6b6a64">the call is yours</text>

  <path d="M 144 184 V 232" fill="none" stroke="#504e49" stroke-width="1.5"/>
  <path d="M 140 226 L 144 232 L 148 226" fill="none" stroke="#504e49" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M 144 296 V 344" fill="none" stroke="#504e49" stroke-width="1.5"/>
  <path d="M 140 338 L 144 344 L 148 338" fill="none" stroke="#504e49" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>

  <path d="M 224 376 H 672" fill="none" stroke="#504e49" stroke-width="1.5"/>
  <path d="M 664 372 L 672 376 L 664 380" fill="none" stroke="#504e49" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>

  <path d="M 752 184 V 232" fill="none" stroke="#504e49" stroke-width="1.5"/>
  <path d="M 748 226 L 752 232 L 756 226" fill="none" stroke="#504e49" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M 752 296 V 344" fill="none" stroke="#504e49" stroke-width="1.5"/>
  <path d="M 748 338 L 752 344 L 756 338" fill="none" stroke="#504e49" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
...
Read it as two lanes with one bridge. You deconstruct (PROBLEM to TRUTHS to BRIEF), the brief crosses to the AI lane, and the AI generates, tests, and iterates until the truths hold. The two ink-blue strokes are the mechanism: the truths filter the tests, and the loop is where failure is useful, because a candidate that fails a test is cheap and the test itself is fixed. The end node sits in the AI lane but is labeled "the call is yours", because only you hold the domain intent that distinguishes a LAW from an ARTIFACT.
