---
layout: post
title: "OpenAI Releases GPT Transcribe and GPT Live Transcribe"
date: 2026-07-30
tags: news
categories: news
---
...
**Related:** [OpenAI Releases GPT-Realtime 2 Voice Models]({% post_url 2026-05-07-openai-releases-gpt-realtime-2 %}), [OpenAI Develops Bidirectional Audio Model]({% post_url 2026-03-09-openai-bidirectional-audio-model %})

[GPT Transcribe API docs](https://developers.openai.com/api/docs/models/gpt-transcribe) | [GPT Live Transcribe API docs](https://developers.openai.com/api/docs/models/gpt-live-transcribe) | [AA-WER benchmark](https://artificialanalysis.ai/speech-to-text/non-streaming#error-rate-tabs)
