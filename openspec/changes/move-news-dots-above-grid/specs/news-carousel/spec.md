...
The carousel SHALL include clickable navigation dots above the news grid. Each dot corresponds to one view. Clicking a dot SHALL switch the visible view to the corresponding news card group.
